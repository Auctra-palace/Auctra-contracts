...
vim auctra_minting/tests/snapshot_validation.rs
...
git add auctra_minting/tests/snapshot_validation.rs  # if you updated expected keys
...
Edit these in `auctra_minting/tests/snapshot_validation.rs`:
