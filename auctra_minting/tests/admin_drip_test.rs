...
fn test_admin_drip_fiat_success() {
    ...
    assert_eq!(
        ...
        0,
        "stoken_client.balance(&recipient) should equal 0"
    );
    ...
    assert_eq!(
        stoken_client.balance(&recipient),
        amount,
        "stoken_client.balance(&recipient) should equal amount"
    );
    assert_eq!(
        stoken_client.balance(&client.address),
        0,
        "stoken_client.balance(&client.address) should equal 0"
    );
}
